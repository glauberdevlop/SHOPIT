...
const Cart = ({ history }) => {
    ...
    return (
        <Fragment>
            <MetaData title={'Yuor Cart'} />
            {cartItems.length === 0 ? <h2 classNameName="mt-5">Yuor Carty is Empty</h2> : (
                <Fragment>
                                            ...
                                            <div className="col-4 col-lg-3 mt-4 mt-lg-0">
                                                <div className="stockCounter d-inline">
                                                    <span className="btn btn-danger minus"
                                                        onClick={() => decreateQty(item.product, item.quantity)}
                                                    >-</span>
                                                    <input
                                                        type="number"
